...
const COMPARISONS: Record<string, GlobalComparison> = {
  ...
  "bang-saray": { worldCity: "Cascais", country: "Portugal", population: "~210K", why: "Fishing village near major metro transitioning to upscale coastal living, managing gentrification while preserving local character", whyTh: "หมู่บ้านชาวประมงใกล้มหานครเปลี่ยนผ่านสู่ชีวิตชายฝั่งระดับสูง จัดการ gentrification พร้อมรักษาเอกลักษณ์ท้องถิ่น" },
  chanthaburi: { worldCity: "Antwerp", country: "Belgium", population: "~530K", why: "Global gem trading hub with historic port district, transitioning traditional trade to digital platforms", whyTh: "ศูนย์กลางค้าอัญมณีระดับโลกกับย่านท่าเรือประวัติศาสตร์ เปลี่ยนผ่านการค้าดั้งเดิมสู่แพลตฟอร์มดิจิทัล" },
  "khao-khun-song": { worldCity: "Almere", country: "Netherlands", population: "~210K", why: "Planned smart agriculture community using precision farming and IoT to boost yield on limited land", whyTh: "ชุมชนเกษตรอัจฉริยะที่วางแผนใช้ precision farming และ IoT เพิ่มผลผลิตบนที่ดินจำกัด" },
  "klong-phadung": { worldCity: "Amsterdam Canal District", country: "Netherlands", population: "~870K city", why: "Historic canal network reinvented as smart water management and cultural tourism corridor", whyTh: "เครือข่ายคลองประวัติศาสตร์นำกลับมาเป็นระเบียงจัดการน้ำอัจฉริยะและท่องเที่ยวเชิงวัฒนธรรม" },
  maesai: { worldCity: "Lào Cai", country: "Vietnam", population: "~110K", why: "Northern border trade town at international crossing, managing commerce flow with limited urban infrastructure", whyTh: "เมืองค้าชายแดนเหนือที่จุดข้ามแดนระหว่างประเทศ จัดการกระแสการค้าด้วยโครงสร้างพื้นฐานเมืองจำกัด" },
  makkasan: { worldCity: "King's Cross, London", country: "UK", population: "~67 acres redevelopment", why: "Railway land redevelopment in capital city — transforming derelict rail yards into innovation district", whyTh: "พัฒนาที่ดินรถไฟในเมืองหลวง — เปลี่ยนลานจอดรถไฟร้างเป็นย่านนวัตกรรม" },
  narathiwat: { worldCity: "Derry/Londonderry", country: "UK", population: "~85K", why: "Post-conflict city rebuilding civic trust through governance and community development despite security challenges", whyTh: "เมืองหลังขัดแย้งสร้างความไว้วางใจผ่านธรรมาภิบาลและพัฒนาชุมชนท่ามกลางความท้าทายด้านความมั่นคง" },
  "nikhom-phatthana": { worldCity: "Jurong", country: "Singapore", population: "~95K district", why: "Industrial estate district becoming smart manufacturing hub with worker welfare integration", whyTh: "เขตนิคมอุตสาหกรรมเป็นศูนย์กลางการผลิตอัจฉริยะพร้อมบูรณาการสวัสดิภาพแรงงาน" },
  ...
  pattani: { worldCity: "Derry/Londonderry", country: "UK", population: "~85K", why: "Historic Malay trading port rebuilding identity through cultural heritage and education despite prolonged conflict", whyTh: "ท่าเรือค้าขายมลายูประวัติศาสตร์สร้างอัตลักษณ์ใหม่ผ่านมรดกวัฒนธรรมและการศึกษาท่ามกลางความขัดแย้งยืดเยื้อ" },
  phangnga: { worldCity: "Banda Aceh", country: "Indonesia", population: "~270K", why: "Coastal community rebuilt after tsunami with resilience-first infrastructure and marine conservation focus", whyTh: "ชุมชนชายฝั่งฟื้นตัวหลังสึนามิด้วยโครงสร้างพื้นฐานเน้นความยืดหยุ่นและอนุรักษ์ทะเล" },
  ...
  "phitsanulok-nu": { worldCity: "Lund", country: "Sweden", population: "~125K", why: "University-anchored smart city R&D hub where campus innovation drives regional development beyond the city", whyTh: "ศูนย์ R&D เมืองอัจฉริยะยึดโยงมหาวิทยาลัย นวัตกรรมแคมปัสขับเคลื่อนการพัฒนาภูมิภาคนอกเมือง" },
  "phitsanulok-ppao": { worldCity: "Oulu", country: "Finland", population: "~210K", why: "Provincial governance hub leveraging digital services to coordinate across scattered rural municipalities", whyTh: "ศูนย์กลางปกครองจังหวัดใช้บริการดิจิทัลประสานงานข้ามเทศบาลชนบทกระจัดกระจาย" },
  phlapphla: { worldCity: "Vauban, Freiburg", country: "Germany", population: "~5.5K district", why: "Small sustainable district proving car-free, community-designed smart living works at neighborhood scale", whyTh: "เขตยั่งยืนขนาดเล็กพิสูจน์ว่าชีวิตอัจฉริยะไร้รถยนต์ออกแบบโดยชุมชนทำงานได้ในระดับย่าน" },
  "phuket-tinicon": { worldCity: "Cyberjaya", country: "Malaysia", population: "~120K", why: "Purpose-built tech innovation district on resort island — balancing IT park ambition with tourism reality", whyTh: "ย่านนวัตกรรมเทคโนโลยีสร้างขึ้นเฉพาะบนเกาะรีสอร์ต — สมดุลความทะเยอทะยาน IT park กับความจริงท่องเที่ยว" },
  rattanakosin: { worldCity: "Malacca Historic City", country: "Malaysia", population: "~500K", why: "UNESCO-caliber historic island district balancing heritage preservation with livability and tourism management", whyTh: "เขตเกาะประวัติศาสตร์ระดับ UNESCO สมดุลอนุรักษ์มรดกกับความน่าอยู่และจัดการท่องเที่ยว" },
  "samut-prakan": { worldCity: "Batangas", country: "Philippines", population: "~330K", why: "Industrial port city adjacent to capital with manufacturing base, environmental monitoring needs from factory density", whyTh: "เมืองท่าอุตสาหกรรมติดเมืองหลวง ฐานการผลิต ต้องการเฝ้าระวังสิ่งแวดล้อมจากความหนาแน่นโรงงาน" },
  satun: { worldCity: "Langkawi", country: "Malaysia", population: "~100K", why: "Geopark island tourism destination with quiet eco-tourism positioning, marine biodiversity conservation", whyTh: "แหล่งท่องเที่ยวเกาะจีโอพาร์คที่วางตำแหน่งท่องเที่ยวเชิงนิเวศ อนุรักษ์ความหลากหลายทางทะเล" },
  "songkhla-city": { worldCity: "Hue", country: "Vietnam", population: "~350K", why: "Cultural heritage lake city in southern region, balancing traditional identity with modern urban development", whyTh: "เมืองมรดกวัฒนธรรมริมทะเลสาบภาคใต้ สมดุลอัตลักษณ์ดั้งเดิมกับพัฒนาเมืองสมัยใหม่" },
  sritrang: { worldCity: "Penang (George Town)", country: "Malaysia", population: "~750K", why: "Community-driven heritage district with strong civic participation and creative economy emerging from cultural base", whyTh: "เขตมรดกขับเคลื่อนโดยชุมชน การมีส่วนร่วมพลเมืองเข้มแข็ง เศรษฐกิจสร้างสรรค์เกิดจากฐานวัฒนธรรม" },
  "tai-yong": { worldCity: "Rural Estonia (Setomaa)", country: "Estonia", population: "~3K", why: "Remote rural community accessing world-class digital governance through national e-services infrastructure", whyTh: "ชุมชนชนบทห่างไกลเข้าถึงธรรมาภิบาลดิจิทัลระดับโลกผ่านโครงสร้างพื้นฐาน e-services ระดับชาติ" },
  tak: { worldCity: "Mae Sot–Myawaddy Corridor", country: "Myanmar/Thailand", population: "~200K border zone", why: "Border SEZ managing cross-border labor, trade logistics, and economic zone development simultaneously", whyTh: "SEZ ชายแดนจัดการแรงงานข้ามพรมแดน โลจิสติกส์การค้า และพัฒนาเขตเศรษฐกิจพร้อมกัน" },
  "thep-paraj": { worldCity: "Aspern Seestadt, Vienna", country: "Austria", population: "~25K planned", why: "Smart neighborhood development within larger metro area — testing ground for integrated urban services", whyTh: "พัฒนาย่านอัจฉริยะในเขตมหานครใหญ่ — พื้นที่ทดสอบบริการเมืองแบบบูรณาการ" },
  ubon: { worldCity: "Vientiane", country: "Laos", population: "~820K", why: "Major Mekong corridor city with cultural festival fame, regional governance hub for Isan's eastern edge", whyTh: "เมืองหลักระเบียงแม่น้ำโขง มีชื่อเสียงเทศกาลวัฒนธรรม ศูนย์กลางปกครองภูมิภาคอีสานตะวันออก" },
  "ubon-muni": { worldCity: "Savannakhet", country: "Laos", population: "~125K", why: "Municipal core within larger Mekong province, managing urban services for growing regional population", whyTh: "แกนกลางเทศบาลในจังหวัดริมโขงขนาดใหญ่ จัดการบริการเมืองสำหรับประชากรภูมิภาคที่เติบโต" },
  umong: { worldCity: "Freiburg Green District", country: "Germany", population: "~230K city", why: "Small district near university city pioneering green energy and sustainable community practices", whyTh: "เขตเล็กใกล้เมืองมหาวิทยาลัยบุกเบิกพลังงานสีเขียวและแนวปฏิบัติชุมชนยั่งยืน" },
};
