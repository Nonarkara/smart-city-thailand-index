...
const COMPARISONS: Record<string, GlobalComparison> = {
  ...
  "wangchan-valley": { worldCity: "Songdo", country: "South Korea", population: "~170K planned", why: "Greenfield smart city on empty land with massive investment plan — same risk of building without demand", whyTh: "เมืองอัจฉริยะ greenfield บนที่ดินว่างพร้อมแผนลงทุนมหาศาล — ความเสี่ยงเดียวกันคือสร้างโดยไม่มีอุปสงค์", whyZh: "空地绿地智慧城市，投资计划庞大——与未有需求便建设的风险相同" },
