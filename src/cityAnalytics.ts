...
const COMPARISONS: Record<string, GlobalComparison> = {
  ...
  "tai-yong": { worldCity: "Rural Estonia (Setomaa)", country: "Estonia", population: "~3K", why: "Remote rural community accessing Estonia's benchmark e-services infrastructure (X-Road, digital ID) built for national rollout", whyTh: "ชุมชนชนบทห่างไกลเข้าถึงโครงสร้างพื้นฐาน e-services ต้นแบบของเอสโตเนีย (X-Road, บัตรประจำตัวดิจิทัล) ที่สร้างขึ้นเพื่อใช้งานทั่วประเทศ", whyZh: "偏远农村社区，通过爱沙尼亚全国推广的标杆级电子服务基础设施（X-Road、数字身份证）获得数字治理" },
