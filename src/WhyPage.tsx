...
const references = [
  ...
  { id: 3, text: { en: "Measuring progress of smart cities: Indexing the smart city indices — Technological Forecasting and Social Change (2022)", th: "Measuring progress of smart cities — Technological Forecasting and Social Change (2022)", zh: "衡量智慧城市进展：智慧城市指数的指数化——《技术预测与社会变革》(2022)" }, url: "https://www.sciencedirect.com/science/article/pii/S2664328622000699" },
