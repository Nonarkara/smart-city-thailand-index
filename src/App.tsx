...
const PRIMARY_NAV_ITEMS: NavItem[] = [
  ...
  { kind: "methodology", path: "/methodology", label: { en: "Method", th: "ระเบียบวิธี", zh: "方法" } },
  { kind: "audit", path: "/audit", label: { en: "Audit", th: "ตรวจสอบ", zh: "审计" } },
];

const SECONDARY_NAV_ITEMS: NavItem[] = [
  { kind: "story", path: "/story", label: { en: "Story", th: "เรื่อง", zh: "叙事" } },
  { kind: "showcase", path: "/showcase", label: { en: "NST", th: "นครฯ", zh: "NST" } },
  ...
  { kind: "why", path: "/why", label: { en: "Why", th: "ทำไม", zh: "为何" } },
];
        ...
        <div className="section footer-grid">
          <div className="footer-note-block">
            ...
            <p className="footer-note">
              {translate(locale, {
                en: "A public index of Thai smart-city delivery, built to compare what is announced with what can actually be verified.",
                th: "ดัชนีสาธารณะของการส่งมอบเมืองอัจฉริยะไทย สร้างขึ้นเพื่อเทียบสิ่งที่ประกาศกับสิ่งที่ตรวจสอบได้จริง",
                zh: "一个面向公众的泰国智慧城市交付指数，用来比较“宣布了什么”和“真正能核实什么”。",
              })}
            </p>
          </div>
