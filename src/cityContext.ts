...
export const cityContexts: Record<string, CityContext> = {
  phuket: {
    ...
    theCatch: { en: "High tourist density and seasonal water resource pressure. Significant traffic congestion on the primary north-south corridor. Cost of living significantly higher than the regional average.", th: "ความหนาแน่นนักท่องเที่ยวและแรงกดดันต่อทรัพยากรน้ำตามฤดูกาล ปัญหาสภาพการจราจรบนเส้นทางหลักเหนือ-ใต้ ค่าครองชีพสูงกว่าค่าเฉลี่ยภูมิภาคอย่างชัดเจน" },
    landArea: 543,
  },
  samyan: {
    ...
    theCatch: { en: "Air quality challenges (PM2.5 32.4). Urban crime rates characteristic of a capital city core. The designated smart zone is currently limited in geographic scope, transitioning quickly into traditional urban layouts.", th: "ความท้าทายด้านคุณภาพอากาศ (PM2.5 32.4) อัตราอาชญากรรมเลียนแบบย่านใจกลางเมืองหลวง เขตอัจฉริยะที่กำหนดไว้ยังมีขอบเขตจำกัดและเปลี่ยนผ่านเข้าสู่พื้นที่เมืองดั้งเดิมอย่างรวดเร็ว" },
    landArea: 3.2,
  },
  "chiang-mai-old-town": {
  ...
  "hat-yai": {
    livelihood: { en: "Retail, logistics, education, healthcare, and cross-border commerce with Malaysia. Hat Yai is the commercial workhorse of the lower south, with night markets, malls, bus terminals, rail links, and medical services all packed into a compact urban core.", th: "ค้าปลีก โลจิสติกส์ การศึกษา สาธารณสุข และการค้าข้ามแดนกับมาเลเซีย หาดใหญ่คือเมืองเครื่องยนต์การค้าของภาคใต้ตอนล่าง มีทั้งตลาดกลางคืน ห้างสรรพสินค้า สถานีขนส่ง รถไฟ และบริการแพทย์ในแกนเมืองที่กระชับ" },
    famousFor: { en: "Smart flood management, digital commercial district management, and cross-border trade digitization. The important baseline here is not just tourism: it is night markets, shopping, logistics, and the Thailand-Malaysia gateway role.", th: "การจัดการน้ำท่วมอัจฉริยะ การจัดการย่านการค้าดิจิทัล และการค้าข้ามแดนแบบดิจิทัล ฐานสำคัญของเมืองนี้ไม่ใช่แค่ท่องเที่ยว แต่คือ ตลาดกลางคืน การช้อปปิ้ง โลจิสติกส์ และบทบาทประตูไทย-มาเลเซีย" },
  ...
  "wangchan-valley": {
    ...
    famousFor: { en: "Being ranked #1 smart city in Thailand by the old index. In reality: construction progress is currently under 10%. Reflects a significant gap between theoretical planning and physical implementation.", th: "ถูกจัดอันดับ #1 เมืองอัจฉริยะไทยจากดัชนีเก่า ในความเป็นจริง: ความคืบหน้าการก่อสร้างปัจจุบันยังไม่ถึง 10% สะท้อนถึงช่องว่างที่สำคัญระหว่างการวางแผนเชิงทฤษฎีและการดำเนินงานจริง" },
    opportunity: { en: "If PTT actually builds it, the land and infrastructure planning are sound. EECi concept is aligned with national policy. But until physical implementation accelerates, it remains primarily a strategic masterplan.", th: "ถ้า PTT สร้างจริง การวางแผนที่ดินและโครงสร้างพื้นฐานดี แนวคิด EECi ตรงกับนโยบายชาติ แต่จนกว่าการดำเนินงานจริงจะเร่งตัวขึ้น มันยังคงเป็นเพียงแผนแม่บทเชิงกลยุทธ์หลัก" },
    theCatch: { en: "Zero residents. Zero commercial activity. Zero operational infrastructure. The certification was awarded based on conceptual design rather than operational maturity. This highlights the governance gap that this index aims to monitor.", th: "ยังไม่มีผู้อยู่อาศัย กิจกรรมเชิงพาณิชย์ และโครงสร้างพื้นฐานปฏิบัติการ ตราสัญลักษณ์ได้รับการรับรองตามแนวคิดการออกแบบมากกว่าความพร้อมในการดำเนินงานจริง สิ่งนี้เน้นย้ำถึงช่องว่างการกำกับดูแลที่ดัชนีนี้มุ่งหวังที่จะติดตาม" },
    landArea: 32,
  },
  "mae-moh": {
  ...
  makkasan: {
    ...
    famousFor: { en: "Designated transit-oriented development (TOD) hub. Comprehensive master-planning for multi-modal transport connectivity within central Bangkok.", th: "พื้นที่พัฒนาโดยใช้ระบบขนส่งสาธารณะเป็นศูนย์กลาง (TOD) แผนแม่บทที่ครอบคลุมสำหรับการเชื่อมต่อการเดินทางหลายรูปแบบในพื้นที่ใจกลางกรุงเทพฯ" },
    opportunity: { en: "Exceptional strategic location as a gateway between internal rail networks and international airport links. High potential for transit-driven land value appreciation.", th: "ทำเลเชิงกลยุทธ์ที่เป็นประตูระหว่างโครงการรถไฟภายในประเทศและการเชื่อมต่อสนามบินนานาชาติ ศักยภาพสูงสำหรับการเพิ่มมูลค่าที่ดินที่ขับเคลื่อนโดยการขนส่ง" },
    theCatch: { en: "Implementation phase is in early pre-development. Success depends on the timely execution of large-scale infrastructure projects that have yet to achieve operational status. Complexity of multi-modal transport integration remains a significant risk.", th: "ระยะการดำเนินการอยู่ในช่วงเริ่มต้นก่อนการพัฒนา ความสำเร็จขึ้นอยู่กับการดำเนินโครงการโครงสร้างพื้นฐานขนาดใหญ่ที่ยังไม่บรรลุสถานะการทำงานจริง ความซับซ้อนของการเชื่อมต่อการเดินทางหลายรูปแบบยังคงเป็นความเสี่ยงที่สำคัญ" },
  },
  "klong-phadung": {
  ...
  "phuket-tinicon": {
    ...
    famousFor: { en: "Conceptual design for a high-tech innovation hub in Phuket. Intended to diversify the island's economy through digital and creative industries.", th: "แนวคิดการออกแบบสำหรับศูนย์กลางนวัตกรรมในภูเก็ต เป้าหมายเพื่อสร้างความหลากหลายให้แก่เศรษฐกิจของเกาะผ่านอุตสาหกรรมดิจิทัลและสร้างสรรค์" },
    opportunity: { en: "Strong potential to leverage Phuket's global brand to attract international tech talent and digital nomadic professionals.", th: "ศักยภาพสูงในการดึงดูดแบรนด์ระดับโลกของภูเก็ตเพื่อดึงดูดบุคลากรด้านเทคโนโลยีและกลุ่ม digital nomad นานาชาติ" },
    theCatch: { en: "Current status remains in the design and feasibility phase. Transitioning from conceptual vision to measurable physical development is the critical next milestone.", th: "สถานะปัจจุบันยังอยู่ในช่วงการออกแบบและการศึกษาความเป็นไปได้ การเปลี่ยนผ่านจากวิสัยทัศน์เชิงแนวคิดไปสู่การพัฒนาทางกายภาพที่วัดผลได้คือขั้นตอนสำคัญ" },
  },
  rattanakosin: {
