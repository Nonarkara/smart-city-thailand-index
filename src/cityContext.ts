...
export const cityContexts: Record<string, CityContext> = {
  phuket: {
    ...
    opportunity: { en: "Smart tourism infrastructure is real and exportable. Marine monitoring tech could become an ASEAN model. The 2004 tsunami created a culture of disaster preparedness that other coastal cities lack.", th: "โครงสร้างพื้นฐานการท่องเที่ยวอัจฉริยะเป็นจริงและส่งออกได้ เทคโนโลยีเฝ้าระวังทะเลอาจเป็นโมเดลอาเซียน สึนามิ 2547 สร้างวัฒนธรรมเตรียมพร้อมรับภัยพิบัติที่เมืองชายฝั่งอื่นไม่มี", zh: "智慧旅游基础设施已落地且可出口。海洋监测技术有望成为东盟范本。2004年海啸孕育了其他沿海城市所缺乏的防灾文化。" },
  ...
  "khon-kaen": {
    ...
    opportunity: { en: "Private-sector-led model (KKTS consortium) is unique in Thailand and could be exported. Smart bus is already running. High-speed rail connection to Bangkok and Nong Khai (Laos border) will transform logistics.", th: "โมเดลที่นำโดยเอกชน (กลุ่ม KKTS) เป็นเอกลักษณ์ในไทยและส่งออกได้ รถบัสอัจฉริยะวิ่งแล้ว รถไฟความเร็วสูงเชื่อมกรุงเทพฯ-หนองคาย (ชายแดนลาว) จะเปลี่ยนโลจิสติกส์", zh: "私营主导模式（KKTS联合体）在泰国独一无二且可出口。智能巴士已运营。连接曼谷至廊开（老挝边境）的高铁将彻底改变物流格局。" },
  ...
  saensuk: {
    ...
    famousFor: { en: "Real-time beach water quality monitoring — bacteria counts visible to the public. Smart waste collection with GPS-tracked trucks. Small but genuine.", th: "เฝ้าระวังคุณภาพน้ำชายหาดเรียลไทม์ — ปริมาณแบคทีเรียเปิดเผยต่อสาธารณะ เก็บขยะอัจฉริยะด้วยรถติดตาม GPS เล็กแต่จริง", zh: "实时海滩水质监测——细菌计数向公众公开。GPS追踪垃圾车的智慧废物收集。规模小但货真价实。" },
    opportunity: { en: "A model for how small beachfront municipalities can do smart city right. Low cost, high impact. The water quality transparency approach is replicable everywhere.", th: "โมเดลว่าเทศบาลริมหาดขนาดเล็กทำเมืองอัจฉริยะถูกวิธีได้อย่างไร ต้นทุนต่ำ ผลกระทบสูง แนวทางความโปร่งใสคุณภาพน้ำทำซ้ำได้ทุกที่", zh: "小型滨海市政当局正确实践智慧城市的范本。低成本，高影响。水质透明度做法可在各地复制。" },
  ...
  "songkhla-city": {
    ...
    famousFor: { en: "Smart governance and tourism tech with strong cultural identity. Hospitality 76. Lake ecosystem monitoring. PSU research capacity supports genuine innovation.", th: "ปกครองอัจฉริยะและเทคท่องเที่ยวด้วยอัตลักษณ์วัฒนธรรมเข้มแข็ง การท่องเที่ยว 76 เฝ้าระวังระบบนิเวศทะเลสาบ ศักยภาพวิจัย มอ.สนับสนุนนวัตกรรมจริง", zh: "强烈文化认同下的智慧治理和旅游科技。旅游评分76。湖泊生态系统监测。宋王大研究能力支撑真实创新。" },
    opportunity: { en: "Songkhla Lake monitoring could become a model for ASEAN inland water body management. University + cultural heritage + lake = unique tourism positioning.", th: "การเฝ้าระวังทะเลสาบสงขลาอาจเป็นโมเดลจัดการแหล่งน้ำในอาเซียน มหาวิทยาลัย + มรดกวัฒนธรรม + ทะเลสาบ = วางตำแหน่งท่องเที่ยวเฉพาะ", zh: "宋卡湖监测可成为东盟内陆水体管理的示范。大学+文化遗产+湖泊=独特的旅游定位。" },
