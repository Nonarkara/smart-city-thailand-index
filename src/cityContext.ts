...
export const cityContexts: Record<string, CityContext> = {
  ...
  "chiang-mai-old-town": {
    ...
    opportunity: { en: "IoT-assisted heritage monitoring at the old city's temple sites, paired with a growing air-quality sensor network, could become a model for haze-affected cities across mainland Southeast Asia.", th: "การเฝ้าระวังมรดกด้วย IoT ที่กลุ่มวัดในเมืองเก่า ร่วมกับเครือข่ายเซ็นเซอร์คุณภาพอากาศที่กำลังขยาย อาจเป็นโมเดลสำหรับเมืองที่ได้รับผลกระทบจากหมอกควันทั่วเอเชียตะวันออกเฉียงใต้แผ่นดินใหญ่", zh: "在古城寺庙群部署的IoT遗产监测，加上不断扩展的空气质量传感网络，有望成为东南亚大陆雾霾城市的参考范本。" },
  ...
  "khon-kaen": {
    ...
    famousFor: { en: "Isan's economic capital. The LRT that's been coming for years. Khon Kaen University. Dinosaur fossils. One of the few Thai cities where the private sector — not government — drove the smart city push.", th: "เมืองหลวงเศรษฐกิจอีสาน LRT ที่รอมาหลายปี มหาวิทยาลัยขอนแก่น ฟอสซิลไดโนเสาร์ เป็นหนึ่งในไม่กี่เมืองของไทยที่ภาคเอกชน — ไม่ใช่รัฐบาล — เป็นผู้ขับเคลื่อนการผลักดันเมืองอัจฉริยะ", zh: "泰东北经济首府。迟迟未能落地的轻轨。孔敬大学。恐龙化石。是泰国少数由私营部门而非政府主导推动智慧城市建设的城市之一。" },
    opportunity: { en: "The KKTS consortium has piloted a municipal digital-token / e-voucher scheme (the KGO Token) — a rare private-sector-led model in Thailand. High-speed rail to Bangkok and Nong Khai (Laos border) will transform the logistics play.", th: "กลุ่ม KKTS ได้นำร่องระบบโทเคนดิจิทัล/e-voucher ระดับเทศบาล (KGO Token) — โมเดลที่นำโดยเอกชนซึ่งหาได้ยากในไทย รถไฟความเร็วสูงสู่กรุงเทพฯ-หนองคาย (ชายแดนลาว) จะเปลี่ยนโฉมด้านโลจิสติกส์", zh: "KKTS联合体试点了一套市政级数字代币/电子凭证方案（KGO Token）——在泰国属于少见的私营主导模式。连接曼谷至廊开（老挝边境）的高铁将重塑物流格局。" },
  ...
  "nakhon-si-thammarat": {
    ...
    famousFor: { en: "The city that listened. Near-universal LINE adoption in a city of ~110,000. Real-time flood telemetry and early warning. The ASEAN CSCO Handbook model city. Mayor Kanop Ketchart's direct LINE Q&A sessions.", th: "เมืองที่ฟัง การใช้ LINE เกือบทั่วทั้งเมืองในเมืองที่มีประชากรราว 110,000 คน ระบบโทรมาตรและเตือนภัยน้ำท่วมแบบเรียลไทม์ เมืองต้นแบบ ASEAN CSCO Handbook นายกกณพ เกตุชาติ ตอบคำถามประชาชนโดยตรงบน LINE", zh: "倾听型城市。在约11万人口的城市实现近乎全民的LINE覆盖。实时洪水遥测与预警。东盟CSCO手册样板城市。市长Kanop Ketchart在LINE上直接答疑。" },
  ...
  yala: {
    ...
    famousFor: { en: "A multiple-time winner of Thailand's cleanest-city award. Green space management exceeding national standards. Smart city achievements despite being in an active conflict zone.", th: "เมืองที่คว้ารางวัลเมืองสะอาดที่สุดของไทยหลายสมัย จัดการพื้นที่สีเขียวเกินมาตรฐานชาติ ความสำเร็จเมืองอัจฉริยะแม้อยู่ในเขตขัดแย้ง", zh: "多次荣获泰国最清洁城市奖。绿地管理超越国家标准。在活跃冲突区取得智慧城市成就。" },
  ...
  "mae-moh": {
    ...
    opportunity: { en: "Smart energy monitoring here is genuinely exportable. The coal-to-clean transition model could be applied at other EGAT sites and ASEAN coal communities.", th: "ระบบติดตามพลังงานอัจฉริยะที่นี่ส่งออกได้จริง โมเดลเปลี่ยนผ่านถ่านหินสู่สะอาดส่งออกไปไซต์ กฟผ. อื่นและชุมชนถ่านหินอาเซียนได้", zh: "这里的智慧能源监测真正具备可复制推广的价值。煤炭向清洁能源转型模式可应用于其他EGAT站点及东盟煤炭社区。" },
  ...
  makkasan: {
    ...
    opportunity: { en: "If the transit hub is built, the location (central Bangkok, next to Airport Rail Link) is genuinely prime. The land value alone justifies smart infrastructure.", th: "ถ้าศูนย์กลางขนส่งถูกสร้าง ทำเล (กลางกรุงเทพฯ ติด Airport Rail Link) ถือเป็นทำเลชั้นดีจริง มูลค่าที่ดินเพียงอย่างเดียวก็คุ้มค่าโครงสร้างพื้นฐานอัจฉริยะ", zh: "如果交通枢纽建成，其选址（曼谷市中心，紧邻机场快线）堪称黄金地段。仅土地价值本身就足以证明智慧基础设施的合理性。" },
  ...
  phangnga: {
    ...
    famousFor: { en: "Tsunami early warning system with IoT sensors. Smart mangrove conservation monitoring. The only Thai smart city where disaster tech isn't a nice-to-have but a survival necessity.", th: "ระบบเตือนสึนามิด้วยเซ็นเซอร์ IoT เฝ้าระวังอนุรักษ์ป่าชายเลน เมืองอัจฉริยะไทยเมืองเดียวที่เทคภัยพิบัติไม่ใช่ของดี แต่เป็นความจำเป็นเพื่ออยู่รอด", zh: "配备IoT传感器的海啸预警系统。智慧红树林保护监测。泰国唯一一座将灾害科技视为生死攸关必需品而非锦上添花的智慧城市。" },
  ...
  "tai-yong": {
    ...
    opportunity: { en: "Village-scale smart city model is replicable to thousands of Thai tambons. If NST's smart city DNA reaches its sub-districts, the province transforms bottom-up.", th: "โมเดลเมืองอัจฉริยะระดับหมู่บ้านทำซ้ำได้กับตำบลไทยหลายพัน หาก DNA เมืองอัจฉริยะของนครฯ เข้าถึงตำบล จังหวัดเปลี่ยนแปลงจากล่างขึ้นบน", zh: "村级智慧城市模式可向泰国数千个分区复制。若洛坤的智慧城市基因传达至分区，全省将从底层实现转型。" },
    theCatch: { en: "Economy 42. Digital 35. Population 18K — very limited tax base. Needs sustained external funding. Data is sparse (low confidence). Without NST's support, viability is uncertain.", th: "เศรษฐกิจ 42 ดิจิทัล 35 ประชากร 18K — ฐานภาษีจำกัดมาก ต้องการทุนภายนอกอย่างยั่งยืน ข้อมูลเบาบาง (ความเชื่อมั่นต่ำ) หากไม่มีนครฯ สนับสนุน ความอยู่รอดไม่แน่นอน", zh: "经济评分42。数字评分35。人口1.8万——税基极为有限。需要持续的外部资金。数据稀少（置信度低）。若无洛坤的支持，可持续性存疑。" },
  },
  tak: {
  ...
  "reg-roi-et": {
    ...
    famousFor: { en: "Ku Phra Kho Na Khmer ruins, Ban Selaphum silk, and winning the FURD City Award for its PPP smart city financing model. One of the few Thai cities to finance smart city work through bank loans rather than waiting for government grants.", th: "ปราสาทกู่พระโกนา ผ้าไหมบ้านเสลภูมิ และคว้ารางวัล FURD City Award สำหรับโมเดลการเงินเมืองอัจฉริยะ PPP เป็นหนึ่งในไม่กี่เมืองของไทยที่ระดมทุนผ่านสินเชื่อธนาคารแทนการรอเงินอุดหนุนจากรัฐบาล", zh: "考拉纳可玛尔高棉遗址、班色拉蓬丝织，以及凭借PPP智慧城市融资模式荣获FURD城市奖。是泰国少数主动通过银行贷款而非等待政府拨款来融资的城市之一。" },
    ...
    theCatch: { en: "The key constraint is registry status: being in the depa promotion registry is not the same thing as live deployment. GPP per capita is among the lowest in Isan. Loan-financed infrastructure requires disciplined repayment — one election cycle of mismanagement and the model collapses. Population growth is flat. Without continued private-sector co-investment, the PPP frame only works if the first deal succeeds.", th: "ข้อจำกัดหลักคือสถานะในทะเบียน: การอยู่ในทะเบียนส่งเสริมของ depa ไม่ใช่สิ่งเดียวกับการมีระบบใช้งานจริง GPP ต่อหัวอยู่ในระดับต่ำสุดของอีสาน โครงสร้างพื้นฐานที่เงินกู้ต้องการชำระคืนอย่างมีวินัย — ผิดพลาดหนึ่งรอบเลือกตั้งและโมเดลพัง การเติบโตของประชากรแทบไม่มี หากไม่มีการลงทุนร่วมจากเอกชนต่อเนื่อง กรอบ PPP จะได้ผลก็ต่อเมื่อดีลแรกประสบความสำเร็จ", zh: "核心制约是登记状态：列入depa推广名录不等于系统已上线运行。人均GPP在泰东北最低之列。贷款融资的基础设施需要严格还款——一个选举周期的管理失误就能让模式崩溃。人口增长停滞。若无持续的私营部门联合投资，PPP框架只有在第一笔交易成功时才能运转。" },
    landArea: 8299,
  },
  umong: {
