...
export const HOME_COLLECTIONS: HomeCollection[] = [
  {
    ...
    body: {
      ...
      th: "การลงทุนเมืองอัจฉริยะในไทยกำลังเอียงไปทางระบบรางถาวร — การลงทุนที่เปลี่ยนโฉมเมืองยาว 40 ปี ไม่ใช่ 4 ปี",
  ...
  },
  {
    ...
    body: {
      ...
      th: "คนไทยส่วนใหญ่อยู่กับ PM₂.₅ สูงเกินเกณฑ์ WHO เมืองเหล่านี้ไม่ใช่",
  ...
  },
  {
    ...
    headline: {
      ...
      th: "เมืองที่เม็ดเงินเคลื่อนไหว",
      zh: "资金正在流动的地方",
    },
    body: {
      en: "GPP growth, FDI inflow, new industrial estates — cities that outperform the national mean on the money axes.",
      th: "การเติบโต GPP การลงทุนต่างประเทศ นิคมอุตสาหกรรมใหม่ — เมืองที่ทำได้ดีกว่าค่าเฉลี่ยประเทศในแกนเงิน",
