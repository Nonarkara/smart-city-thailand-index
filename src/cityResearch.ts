...
const CITY_RESEARCH_PROFILES: Record<string, CityResearchProfile> = {
  ...
  "wangchan-valley": {
    ...
    funFact: { en: "VISTEC accepts around 150 graduate students per year. KVIS accepts 72 students per year, selected from approximately 5,000–7,000 applicants nationally — a roughly 1-2% acceptance rate. These are genuinely elite institutions — PTT's educational investment is real. What doesn't exist: the smart city around them.", th: "VISTEC รับนักศึกษาบัณฑิตราว 150 คนต่อปี KVIS รับ 72 คนต่อปี คัดเลือกจากผู้สมัคร 5,000–7,000 คนทั่วประเทศ — อัตรารับเข้าราว 1-2% สถาบันเหล่านี้คัดสรรเข้มข้นจริง — การลงทุนด้านการศึกษาของ ปตท. เป็นของจริง สิ่งที่ไม่มีอยู่จริง: เมืองอัจฉริยะที่ล้อมรอบสถาบันเหล่านั้น", zh: "VISTEC每年招收约150名研究生。KVIS每年招收72名学生，从全国约5000-7000名申请者中选拔——录取率约1-2%。这些确实是精英机构——PTT的教育投入是真实的。不存在的是：围绕它们的智慧城市。" },
