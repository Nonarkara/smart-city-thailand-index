...
export const WEEKLY_DIGEST: WeeklyDigest = {
  ...
  trendingCity: {
    ...
    note: {
      ...
      th: "การก่อสร้าง LRT ขอนแก่นผ่านหลัก 60% สัปดาห์นี้ — ขบวนแรกคาดถึงศูนย์ซ่อม Tha Phra ภายใน Q3",
  ...
  headline: {
    title: {
      ...
      th: "depa ประกาศชุดเขตส่งเสริมเมืองอัจฉริยะประจำปี 2569",
      zh: "depa 公布 2026 年度智慧城市推广区名单",
    },
    gloss: {
      en: "Six additional secondary cities enter the promotion pipeline, most of them in the Northeast.",
      th: "เมืองรองอีก 6 เมืองเข้าสู่ไปป์ไลน์การส่งเสริม ส่วนใหญ่อยู่ในภาคตะวันออกเฉียงเหนือ",
