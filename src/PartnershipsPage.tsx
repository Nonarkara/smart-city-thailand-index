...
const TIMELINE: Array<{ year: string; flag: string; project: { en: string; th: string; zh: string }; country: { en: string; th: string; zh: string } }> = [
  ...
  { year: "2018", flag: "🇹🇭", project: { en: "ASCN pilot cities: Bangkok, Phuket, Chonburi selected", th: "เมืองนำร่อง ASCN: กรุงเทพฯ ภูเก็ต ชลบุรี", zh: "ASCN 试点城市选出：曼谷、普吉、春武里" }, country: { en: "Thailand/ASEAN", th: "ไทย/อาเซียน", zh: "泰国/东盟" } },
