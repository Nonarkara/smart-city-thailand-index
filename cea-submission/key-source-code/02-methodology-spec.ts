// Source: src/methodologySpec.ts (live at github.com/Nonarkara/smart-city-thailand-index)
// Score domain, tier thresholds (Alpha/Beta/Gamma), and the validation function every city's scores must pass before they can be composited.
// ---------------------------------------------------------------------------
