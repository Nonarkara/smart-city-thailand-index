// Source: src/routing.ts (live at github.com/Nonarkara/smart-city-thailand-index)
// The entire client-side router. No React Router dependency — proof the 'single-page architecture' claim in the docs is literal, not marketing.
// ---------------------------------------------------------------------------
