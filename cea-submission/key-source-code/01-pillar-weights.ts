// Source: src/types.ts (live at github.com/Nonarkara/smart-city-thailand-index)
// The seven pillar weights (25/20/15/15/10/10/5, sum = 100) — the single constant every score in SCITI traces back to.
// ---------------------------------------------------------------------------
